...
public static class SubscriptionActivity {
    ...
    public static Activity? SetContextTags(this Activity? activity, IMessageConsumeContext context) {
        ...
        return activity
            ...
            .SetTag(TelemetryTags.ThriveEventFlow.Stream, context.Stream)
            .SetTag(TelemetryTags.ThriveEventFlow.Subscription, context.SubscriptionId)
    ...
    public static Activity? Create(
        ...
        => ThriveEventFlowDiagnostics.ActivitySource.CreateActivity(
            name,
            activityKind,
