...
using static ThriveEventFlow.Diagnostics.Tracing.Constants;

// ReSharper disable InvertIf

namespace ThriveEventFlow.Diagnostics.Tracing;
...
public class TracedEventStore : IEventStore {
    ...
    static readonly KeyValuePair<string, object?>[] DefaultTags = ThriveEventFlowDiagnostics.Tags
    ...
    static Activity? StartActivity(StreamName stream, string operationName) {
        ...
        var activity = ThriveEventFlowDiagnostics.ActivitySource.CreateActivity(
        ...
        if (activity is { IsAllDataRequested: true }) {
            ...
            activity.SetTag(TelemetryTags.ThriveEventFlow.Stream, streamName);
        }
