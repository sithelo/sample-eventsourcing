...
public static class ThriveEventFlowDiagnostics {
    ...
    static ThriveEventFlowDiagnostics() => Enabled = Environment.GetEnvironmentVariable("THRIVEEVENTFLOW_DISABLE_DIAGS") != "1";
