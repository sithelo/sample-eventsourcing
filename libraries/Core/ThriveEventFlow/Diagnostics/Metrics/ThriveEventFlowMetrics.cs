...
namespace ThriveEventFlow.Diagnostics.Metrics;

public sealed class ThriveEventFlowMetrics : IWithCustomTags, IDisposable {
    public static readonly string MeterName = ThriveEventFlowDiagnostics.GetMeterName("core");

    readonly Meter                   _meter;
    readonly ActivityListener        _listener;
    KeyValuePair<string, object?>[]? _customTags;

    public ThriveEventFlowMetrics() {
                ...
                case Constants.Components.AppService:
                    RecordWithTags(
                        ...
                        new KeyValuePair<string, object?>(
                            "command",
                            activity.GetTagItem(TelemetryTags.ThriveEventFlow.Command)
                        )
                    );
