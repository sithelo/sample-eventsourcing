...
public static class TelemetryTags {
    ...
    public static class ThriveEventFlow {
        public const string Consumer     = "thriveeventflow.consumer";
        public const string EventHandler = "thriveeventflow.event-handler";
        public const string Subscription = "thriveeventflow.subscription";
        public const string Stream       = "thriveeventflow.stream";
        public const string Partition    = "thriveeventflow.partition";
        public const string Command      = "thriveeventflow.command";
    }
}